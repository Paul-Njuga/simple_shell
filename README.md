...
[![Build Status](https://travis-ci.org/joemccann/dillinger.svg?branch=master)](https://github.com/Paul-Njuga/simple_shell)

## Overview

**Simple Shell** - is an ALX school group project. The task is to write a simple UNIX command interpreter.

Table of contents
=================

<!--ts-->
- [An implementation of sh in C programming language](#an-implementation-of-sh-in-c-programming-language)
	- [Overview](#overview)
...
```
$ git clone https://github.com/Paul-Njuga/simple_shell
```
